...
const string3 = "Na";
console.log(`I think the song goes like ${string3.repeat(4)} Batman!`);
...
/*const start = fruit.indexOf("mango");
const favoritefruit = fruit.slice(start, start + "mango".length);
console.log(favoritefruit);*/ //-another way
